...
# convert from gps lat/lon to CLF-centered cartesian
    ...
    g0000   = geopy.point.Point(39.29693,-112.90875,ZCLF)
    g0000eq = geopy.point.Point(0.0,g0000.longitude,g0000.altitude)
    gnnnneq = geopy.point.Point(0.0,gnnnn.longitude,gnnnn.altitude)

    r = (vincenty(g0000,gnnnn).km)
    y = (vincenty(gnnnn,gnnnneq).km)-(vincenty(g0000,g0000eq).km)
...
# convert sd lat/lon to CLF cartesian
    ...
    for i in range(0,NTASD):
        gsd = geopy.point.Point(tasdlat[i],tasdlon[i],tasdalt[i])
